...
def create_songs(artist_ids):
    with app.app_context():
        ...
        song7 = Song(
            ...
            image='https://i1.sndcdn.com/artworks-000100738651-hgoujv-t500x500.jpg',
        ...
        song8 = Song(
            ...
            image='https://i.pinimg.com/736x/78/6d/d6/786dd6044cdc7bc0cd69a5c7874a33e4.jpg',
        ...
        song10 = Song(
            ...
            release_dt=datetime.strptime('2014-11-10', '%Y-%m-%d'),
            image='https://coverartarchive.org/release/51fedf94-1545-453b-8772-7481ab73d255/3054552949.jpg',
